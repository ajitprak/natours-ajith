...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert alert--".concat(type, "\">").concat(msg, "</div>"); // afterbegin inside the begining immediately after the starting point
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // This is as per the axios doc
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error occured during logout. Please try again !!!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"update-settings.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var baseUrl = 'http://127.0.0.1:8000/'; // type is either passord or data
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? "".concat(baseUrl, "api/v1/users/change-password") : "".concat(baseUrl, "api/v1/users/update-me");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successfully. Reloading ..."));
              setTimeout(function () {
                location.reload();
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(baseUrl, "api/v1/bookings//checkout-session/").concat(tourId)
            });
...
var _updateSettings = require("./update-settings");
